...
knitr::include_graphics("hypothesis-test-intuition.png")
```
]
...
visão Poperiana do método científico é apenas uma entre várias
alternativas.
...
- $[H|D]$ é a probabilidade da hipótese $H$, condicionada aos dados $D$
  (*posterior*)
- $[D|H]$ é a probabilidade do dado, condicionada à hipótese
  (*verossimilhança*)
- $[H]$ é a probabilidade da hipótese (*priori*)
- O resultado será a probabilidade de cada uma das hipóteses
  concorrentes
...
knitr::include_graphics("deduction-induction.png")
...
knitr::include_graphics("feedback-loop.png")
```
...
```{r, echo=FALSE, out.width='60%'}
knitr::include_graphics("feynman.jpg")
```
